  ...
  return (
    <div>
      ...
      <div className="space-y-2 mt-4">
        <button className="w-full cursor-pointer border border-red-400  bg-base-200 text-red-400 px-6 py-2 rounded-md font-semibold flex items-center gap-2 justify-center hover:bg-red-400 hover:text-white transition-all duration-300">
